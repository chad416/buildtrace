...
const routeProbes: readonly RouteProbe[] = [
  ...
  {
    method: 'GET',
    url: '/document-records/machines/machine-1/handover-completeness',
    expectedStatusCode: 400,
  },
  {
    method: 'POST',
    url: '/document-records/machines/machine-1/customer-handover-exports',
    expectedStatusCode: 400,
    payload: {},
  },
  {
    method: 'POST',
    url: '/document-records/machines/machine-1/customer-handover-exports/export-1/download-url',
    expectedStatusCode: 400,
    payload: {},
  },
  {
  ...
  {
    method: 'POST',
    url: '/service-tickets/ticket-1/comments/with-attachment',
    expectedStatusCode: 400,
    payload: {},
  },
  {
    method: 'POST',
    url: '/service-tickets/ticket-1/comments/comment-1/attachment-url',
    expectedStatusCode: 400,
    payload: {},
  },
  {
